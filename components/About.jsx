      ...
      <div className="flex-about">
        <div className="about-text">
          <p>
            ...
            complex problems. I have a strong foundation in Web development, with a focus on web
          ...
          <p>Throughout my career, I have worked on a wide range of projects, from simple static websites to
            ...
            tools and frameworks, including React.js, Next.js, Node.js, and dajngo. I am always eager
